...
using CleanedPinReader = evaf::Sampled< evaf::ExpAdaptiveAverage<evaf::Median<eva::PinJoystick<A0, INPUT, 0, 512, 1024>>>, 10>;
...
// the ADC goes through Median and ExpAdaptiveAverage every 10 ms, while
