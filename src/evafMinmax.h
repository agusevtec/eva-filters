...
{
    /**
     * @brief Reader decorator applying a chunked min-max (morphological) filter.
     *
    ...
    public:
        ...
        /**
         * @brief Apply input reading with chunked min-max filtering.
         *
        ...
        signed short getValue()
        {
            ...
            if (mRing.isFull())
            {
                ...
                value = static_cast<signed short>(
                    ((signed long)getMinimax() + (signed long)getMaximin()) / 2);
            }
